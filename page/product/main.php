        <?php
            include '../../../project2/component/connect/config.php';
            try {
                    ...
                    <?php foreach ($kq as $product) { ?>
                        <div class="showcase">
                            <div class="showcase-banner">
                                <img src="../../../project2<?=$product['img2']?>" alt="<?=$product['name']?>" class="product-img default">
                                <img src="../../../project2<?=$product['img1']?>" alt="<?=$product['name']?>" class="product-img hover">
